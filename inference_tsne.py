...
parser.add_argument('--ckpt_root', default='/media/2TB/result/mmgnet/checkpoint', help='Where checkpoint is')
parser.add_argument('--network_ver', type=str, default='v0.6.2', help='Network version')
parser.add_argument('--dump_dir', type=str, default='ignet_v0.6.2', help='Dump dir to save outputs')
parser.add_argument('--inst_pt_num', type=int, default=1024, help='Dump dir to save outputs')
parser.add_argument('--ckpt_epoch', type=int, default=54, help='Checkpoint epoch name of trained model')
...
parser.add_argument('--seg_root',type=str, default='/media/gpuadmin/rcao/result/uois/graspnet', help='Segmentation results [default: uois]')
parser.add_argument('--seg_model',type=str, default='gt', help='Segmentation results [default: gt]')
...
_, grasp_labels = load_grasp_labels(dataset_root)
...
def inference(scene_idx):
    # elapsed_time_list = []
    for anno_idx in range(0, 256, int(1/image_downsample_ratio)):
        if data_type == 'real':
        ...
        for obj_idx in seg_idxs:
            ...
            gt_obj_idx = np.where(obj_idxs == obj_idx)[0][0]
